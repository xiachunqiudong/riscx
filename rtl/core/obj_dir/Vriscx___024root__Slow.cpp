...
void Vriscx___024root___ctor_var_reset(Vriscx___024root* vlSelf) {
    ...
    vlSelf->riscx__DOT__if_instr = VL_RAND_RESET_I(32);
    ...
    vlSelf->riscx__DOT__if_idu__DOT__pc_dff_lr__DOT__qout_r = VL_RAND_RESET_I(32);
    vlSelf->riscx__DOT__if_idu__DOT__instr_dff_lr__DOT__qout_r = VL_RAND_RESET_I(32);
