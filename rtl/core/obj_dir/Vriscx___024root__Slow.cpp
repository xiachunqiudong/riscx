...
void Vriscx___024root___settle__TOP__3(Vriscx___024root* vlSelf) {
    ...
    // Body
    vlSelf->riscx__DOT__id_ex_pc = vlSelf->riscx__DOT__id_ex_u__DOT__instr_dff__DOT__qout_r;
...
void Vriscx___024root___ctor_var_reset(Vriscx___024root* vlSelf) {
    ...
    vlSelf->riscx__DOT__dec_pc = VL_RAND_RESET_I(32);
    vlSelf->riscx__DOT__dec_instr = VL_RAND_RESET_I(32);
    vlSelf->riscx__DOT__dec_alu_op1 = VL_RAND_RESET_I(32);
    vlSelf->riscx__DOT__dec_alu_op2 = VL_RAND_RESET_I(32);
    vlSelf->riscx__DOT__dec_alu_fun = VL_RAND_RESET_I(4);
    vlSelf->riscx__DOT__dec_rd_en = VL_RAND_RESET_I(1);
    vlSelf->riscx__DOT__id_ex_pc = VL_RAND_RESET_I(32);
    vlSelf->riscx__DOT__id_ex_instr = VL_RAND_RESET_I(32);
    ...
    vlSelf->riscx__DOT__id_ex_u__DOT__alu_op1__DOT__qout_r = VL_RAND_RESET_I(32);
    vlSelf->riscx__DOT__id_ex_u__DOT__alu_op2__DOT__qout_r = VL_RAND_RESET_I(32);
    vlSelf->riscx__DOT__id_ex_u__DOT__alu_fun__DOT__qout_r = VL_RAND_RESET_I(4);
    vlSelf->riscx__DOT__id_ex_u__DOT__rd_idx__DOT__qout_r = VL_RAND_RESET_I(5);
    vlSelf->riscx__DOT__id_ex_u__DOT__rd_en__DOT__qout_r = VL_RAND_RESET_I(1);
