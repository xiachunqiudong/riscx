...
void Vriscx___024root__traceInitSub0(Vriscx___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+14,"riscx ifu if_req_valid_o", false,-1);
        tracep->declBit(c+15,"riscx ifu if_req_ready_i", false,-1);
        tracep->declBus(c+16,"riscx ifu if_req_pc_o", false,-1, 31,0);
        tracep->declBit(c+17,"riscx ifu if_resp_valid_i", false,-1);
        tracep->declBit(c+18,"riscx ifu if_resp_ready_o", false,-1);
        tracep->declBit(c+19,"riscx ifu if_resp_err_i", false,-1);
        tracep->declBus(c+20,"riscx ifu if_resp_instr_i", false,-1, 31,0);
        tracep->declBus(c+11,"riscx ifu if_instr_o", false,-1, 31,0);
        tracep->declBus(c+12,"riscx ifu if_pc_o", false,-1, 31,0);
        tracep->declBus(c+20,"riscx ifu instr", false,-1, 31,0);
        tracep->declBit(c+1,"riscx ifu dec_bjp", false,-1);
        tracep->declBit(c+21,"riscx ifu dec_bxx", false,-1);
        tracep->declBit(c+22,"riscx ifu dec_jal", false,-1);
        tracep->declBit(c+23,"riscx ifu dec_jalr", false,-1);
        tracep->declBus(c+24,"riscx ifu dec_jalr_rs1_idx", false,-1, 4,0);
        tracep->declBus(c+2,"riscx ifu dec_bjp_imm", false,-1, 31,0);
        tracep->declBit(c+3,"riscx ifu prdt_taken", false,-1);
        tracep->declBit(c+25,"riscx ifu jalr_rs1_x0", false,-1);
        tracep->declBit(c+26,"riscx ifu jalr_rs1_x1", false,-1);
        ...
        tracep->declBus(c+20,"riscx ifu fmd_1 instr_i", false,-1, 31,0);
        tracep->declBit(c+1,"riscx ifu fmd_1 dec_bjp_o", false,-1);
        tracep->declBit(c+21,"riscx ifu fmd_1 dec_bxx_o", false,-1);
        tracep->declBit(c+22,"riscx ifu fmd_1 dec_jal_o", false,-1);
        tracep->declBit(c+23,"riscx ifu fmd_1 dec_jalr_o", false,-1);
        tracep->declBus(c+24,"riscx ifu fmd_1 dec_jalr_rs1_idx_o", false,-1, 4,0);
        tracep->declBus(c+2,"riscx ifu fmd_1 dec_bjp_imm_o", false,-1, 31,0);
        tracep->declBus(c+27,"riscx ifu fmd_1 opcode", false,-1, 6,0);
        tracep->declBus(c+28,"riscx ifu fmd_1 bjp_imm_bxx", false,-1, 31,0);
        tracep->declBus(c+29,"riscx ifu fmd_1 bjp_imm_jal", false,-1, 31,0);
        tracep->declBus(c+30,"riscx ifu fmd_1 bjp_imm_jalr", false,-1, 31,0);
    }
}
...
void Vriscx___024root__traceFullSub0(Vriscx___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+14,(vlSelf->riscx__DOT__ifu__DOT__if_req_valid_o));
        tracep->fullBit(oldp+15,(vlSelf->riscx__DOT__ifu__DOT__if_req_ready_i));
        tracep->fullIData(oldp+16,(vlSelf->riscx__DOT__ifu__DOT__if_req_pc_o),32);
        tracep->fullBit(oldp+17,(vlSelf->riscx__DOT__ifu__DOT__if_resp_valid_i));
        tracep->fullBit(oldp+18,(vlSelf->riscx__DOT__ifu__DOT__if_resp_ready_o));
        tracep->fullBit(oldp+19,(vlSelf->riscx__DOT__ifu__DOT__if_resp_err_i));
        tracep->fullIData(oldp+20,(vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i),32);
        tracep->fullBit(oldp+21,((0x63U == (0x7fU & vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i))));
        tracep->fullBit(oldp+22,((0x6fU == (0x7fU & vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i))));
        tracep->fullBit(oldp+23,((0x67U == (0x7fU & vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i))));
        tracep->fullCData(oldp+24,((0x1fU & (vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i 
                                             >> 0xfU))),5);
        tracep->fullBit(oldp+25,((0U == (0x1fU & (vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i 
                                                  >> 0xfU)))));
        tracep->fullBit(oldp+26,((1U == (0x1fU & (vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i 
                                                  >> 0xfU)))));
        tracep->fullCData(oldp+27,((0x7fU & vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i)),7);
        tracep->fullIData(oldp+28,((((- (IData)((vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i 
                                                 >> 0x1fU))) 
                                     << 0xdU) | ((0x1000U 
                                                  & (vlSelf->riscx__DOT__ifu__DOT__if_resp_instr_i 
                                                     >> 0x13U)) 
